...
def mv_to_delim(df: pd.DataFrame, keys: list = [], assoc: dict = {}, cols: list = [], delim: str = ', ') -> pd.DataFrame:
    """
    ...
    def _process_list(df: pd.DataFrame, keys: list = [], lst: list = [], delim: str = ', '):
...
def delim_to_mv(df: pd.DataFrame, keys: list = [], cols: list = [], delim: str = ', ', fill: bool = True) -> pd.DataFrame:
    """
...
def commas_to_mv(df: pd.DataFrame, keys: list = [], cols: list = [], fill: bool = True) -> pd.DataFrame:
...
if __name__ == "__main__": 
    ...
    print('df:\n', df, '\n\n', mv_to_delim(df, keys=keys, assoc={'AWARD':['Award','Type','Date']}, delim=';;'))
